...
* The original package name 'io.kalaisaran.spring-github-OAuth-login-starter' is invalid and this project uses 'io.kalaisaran.spring_github_OAuth_login_starter' instead.
